...
const (
	...
	InstructionsAddSourceAuthors     Instructions = "Введите фамилию и инициалы авторов, через запятую.\n(обязательное поле)."
	InstructionsAddSourceYear        Instructions = "Введите год издания.\n(обязательное поле)."
	InstructionsAddSourceDescription Instructions = "Введите описание источника. Не более 500 знаков."
	InstructionsAddSourceFile        Instructions = "Введите ссылку для скачивания источника с *\"Google drive\"* или *\"Яндекс Диск\"*."
	InstructionsAddSourceSuccess     Instructions = "Источник успешно создан. Для загрузки в библиотеку нажмите кнопку - "

	InstructionsSourceSendToSave Instructions = "Источник передан для сохранения в библиотеку, и появится в ней в течении 30 минут."
